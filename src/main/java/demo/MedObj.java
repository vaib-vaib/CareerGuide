...
public class MedObj {
   ...
   public ArrayList<String> searching_med(int myrank, String catgy){
	   ArrayList<String> myclg = new ArrayList<String>();
	   if (catgy.equals("SC")) {
		   myclg = msclist.search(myrank);
	   }
	   else if (catgy.equals("ST")) {
		   myclg = mstlist.search(myrank);
	   }
	   else if (catgy.equals("VJ")) {
		   myclg =  mvjlist.search(myrank);
	   }
	   else if (catgy.equals("NT1")) {
		   myclg = mnt1list.search(myrank);
	   }
	   else if (catgy.equals("NT2")) {
		   myclg = mnt2list.search(myrank);
	   }
	   else if (catgy.equals("NT3")) {
		   myclg = mnt3list.search(myrank);
	   }
	   else if (catgy.equals("OBC")) {
		   myclg = mobclist.search(myrank);
	   }
	   else if (catgy.equals("SEBC")) {
		   myclg = msebclist.search(myrank);
	   }
	   else if (catgy.equals("EWS")) {
		   myclg = mewslist.search(myrank);
	   }
	   else if (catgy.equals("OPEN")) {
		   myclg = mopenlist.search(myrank);
	   }
	   else
	   {
