...
public class EnggObj {
    ...
    public void startPushing() { 
		...
		public ArrayList<String> searching_engg(int myrank, String catgy,String branch){
			   ArrayList<String> myclg = new ArrayList();
			   if (catgy.equals("SC")) {
				   myclg = esclist.search(myrank,branch);
			   }
			   else if (catgy.equals("ST")) {
				   myclg = estlist.search(myrank,branch);
			   }
			   else if (catgy.equals("VJ")) {
				   myclg = evjlist.search(myrank,branch);
			   }
			   else if (catgy.equals("NT1")) {
				   myclg = ent1list.search(myrank,branch);
			   }
			   else if (catgy.equals("NT2")) {
				   myclg = ent2list.search(myrank,branch);
			   }
			   else if (catgy.equals("NT3")) {
				   myclg = ent3list.search(myrank,branch);
			   }
			   else if (catgy.equals("OBC")) {
				   myclg = eobclist.search(myrank,branch);
			   }
			   else if (catgy.equals("SEBC")) {
				  myclg = esebclist.search(myrank,branch);
			   }
			   else if (catgy.equals("EWS")) {
				   myclg = eewslist.search(myrank,branch);
			   }
			   else if (catgy.equals("OPEN")) {
				   myclg = eopenlist.search(myrank,branch);
			   }
			   else
			   {
